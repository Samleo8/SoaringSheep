...
var requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window
    .msRequestAnimationFrame || window.mozRequestAnimationFrame;
...
var SoaringSheepGame = function() {
    ...
    this.iconNames = ["pause", "play", "music_on", "music_off", "fx_on", "fx_off", "games", "info", "web", "logout",
        ...
        "right_arrow", "shirt", "tick", "restore"];
    ...
    */
    ...
    this.updates = {
        ...
        "accessories": ["no_cape", "no_hat", "crown", "top_hat", "red_cape", "royal_cape", "black_cape",
            "white_cape"]
    };
    ...
    this.initStage = function() {
        ...
        renderer.view.addEventListener((_isMobile) ? "touchstart" : "mousedown", this.heroJump.bind(this),
            false);
    ...
    this.initPreload = function() {
        ...
        this.loader.load((loader, resources) => {
            ...
            this.powerupOffset = this.sprites.spike.height / 100 + this.sprites.powerups[this
            ...
            this.muteMusicButton.on((_isMobile) ? "touchstart" : "mousedown", this.toggleMuteMain.bind(
                this));
            ...
            this.muteFXButton.on((_isMobile) ? "touchstart" : "mousedown", this.toggleMuteFX.bind(
            this));
            ...
            this.gamesButton.on((_isMobile) ? "touchstart" : "mousedown", this.showPlayGamesMenu.bind(
                this));
            ...
            this.webButton.on((_isMobile) ? "touchstart" : "mousedown", this.gotoURL.bind(this,
    ...
    this.generateOverlays = function() {
        ...
        var text2 = new PIXI.Text(
            ...
            ((isApp()) ?
                "The web version is available on my website at\n https://samleo8.github.io/SoaringSheep" :
                "The mobile app is available on the Google Play Store under the name \'Soaring Sheep\'"),
            textOpt2
        );
        ...
        text2 = new PIXI.Text(
            "Material Design Icons\nSpike: http://scribblenauts.wikia.com/wiki/File:Steel_Spike.png",
            textOpt2);
        text2.anchor.set(0.5, 0);
        text2.alpha = 0.98;
        text2.x = this.canvasWidth / 2;
    ...
    this.allAssetsLoaded = function() {
        ...
        bubble.beginFill(0xcfd8dc)
            .drawRoundedRect(-bubble._width / 2, -bubble._height / 2, bubble._width, bubble._height, bubble
                ._radius)
            .drawPolygon(new PIXI.Point(-bubble._width / 2 + 180, -bubble._height / 2 - 60), new PIXI.Point(-
    ...
    this.startGame = function() {
        ...
        this.hero.vy = 0;
        this.hero.ay = 0.10;
        this.hero.jumpStrength = (this.hero.scale.y >= 0.35) ? this.heroJumpStrength : this
            .heroJumpStrength_lamb;
    ...
    this.heroJump = function(event) {
        if (this.preventHeroJump) {
            this
            .preventHeroJump--; //makes sure that all false clicks which have been triggered are accounted for
    ...
    this.update = function() {
        ...
        if (this.hero.x <= this.hero.sheep.width / 2 || this.hero.x >= (this.canvasWidth - this.hero.sheep
                .width / 2)) {
            this.hero.x = Math.min(Math.max(this.hero.sheep.width / 2, this.hero.x), (this.canvasWidth - this
                .hero.sheep.width / 2));
        ...
        if (this.hero.y <= -this.hero.sheep.height / 2 - this.hero.leeway || this.hero.y >= (this.canvasHeight +
                this.hero.sheep.height / 2 + this.hero.leeway)) {
            this.gameover();
            return;
        }
    ...
    this.prepareShopContent = function() {
        ...
        for (i in this.upgrades) {
            ...
            this.upgradesSection[nm].button.on((_isMobile) ? "touchstart" : "mousedown", this.performUpgrade
                .bind(this, nm));
        ...
        this.shop.navArrows.left.on((_isMobile) ? "touchstart" : "mousedown", this.skinPagesNav.bind(this,
            "prev"));
        ...
        this.shop.navArrows.right.on((_isMobile) ? "touchstart" : "mousedown", this.skinPagesNav.bind(this,
            "next"));
        ...
        for (j = 0; j < this.accessoriesNames.length; j++) {
            ...
            this.skinsSection[nm].button.on((_isMobile) ? "touchstart" : "mousedown", this.setAccessory.bind(
                this, nm, data["type"]));
        ...
        this.coinAdButton.on((_isMobile) ? "touchstart" : "mousedown", this.ads.showAd.bind(this.ads,
            "rewardvideo", "coins", 10 * getRandomInt(1, 15)));
        ...
        this.coinBuyButton.on((_isMobile) ? "touchstart" : "mousedown", this.purchases.buy.bind(this.purchases,
            "coins500"));
        ...
        this.restorePurchasesButton.on((_isMobile) ? "touchstart" : "mousedown", this.purchases.restore.bind(
            this.purchases));
        ...
        switch (type) {
            ...
            case "body":
                if (this.hero.sheep == null || typeof this.hero.sheep == "undefined") {
                    ...
                    this.hero.sheep = new PIXI.extras.AnimatedSprite(this.animations[((accessory ==
                            "little_lamb" || accessory == "sheep_running") ? "sheep_base" :
                        accessory)].frames);
                    ...
                    this.hero.sheep.textures = this.animations[((accessory == "little_lamb" || accessory ==
                        "sheep_running") ? "sheep_base" : accessory)].frames;
    ...
    this.gameover = function() {
        if ((this.noDeathChance || this.hero.cape.name == "royal_cape") && Math.random() < (this.noDeathChance +
                this.whiteCapeBonus)) {
            //Just continue game
            requestAnimationFrame(this.update.bind(this));
        ...
        if (this.achievements.incremental.die[4].complete) {
            if (!this.achievements.incremental.die_addicted[0].complete || !this.achievements.incremental
                .die_addicted[0].synced) {
    ...
    this.share_social = function() {
        var options = {
            ...
            ' on Soaring Sheep?', // not supported on some apps (Facebook, Instagram)
    ...
    this.loadOptions = function() {
        if (window.localStorage) {
            ...
            if (window.localStorage.getItem("upgrades_fix") != null && parseBoolean(window.localStorage[
                    "upgrades_fix"])) {
            ...
            if (!window.localStorage.getItem("achievements_coins_fix2") || !parseBoolean(window.localStorage[
                    "achievements_coins_fix2"])) {
                window.localStorage["achievements_coins_fix2"] = true;

                //Time to fix
                if (window.localStorage["achievements"] != null) {
                    alert(
                        "In this latest update, all completed achievements earns you coins to use in the shop!");
                ...
                for (j = 0; j < this.updates[i].length; j++) {
                    ...
                    switch (i) {
                        case "achievements_single":
                            if (this.achievements["single"][nm] == null || typeof this.achievements["single"][
                                    nm] == "undefined")
                                this.achievements["single"][nm] = this.partsForUpdate[i][nm];
                            break;
                        case "achievements_increment":
                            if (this.achievements["incremental"][nm] == null || typeof this.achievements[
                                    "incremental"][nm] == "undefined")
