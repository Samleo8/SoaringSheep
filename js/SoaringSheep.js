    ...
    */
    ...
    this.generateOverlays = function() {
        ...
        */
        ...
        for (var i = 0; i < this.shopTabNames.length; i++) {
            ...
            case "body":
                if (this.hero.sheep == null || typeof this.hero.sheep == "undefined") {
                    ...
                    this.hero.sheep = new PIXI.extras.AnimatedSprite(this.animations[((accessory ==
                        "little_lamb") ? "sheep_base" : accessory)].frames);
                    ...
                    this.hero.sheep.textures = this.animations[((accessory == "little_lamb") ? "sheep_base" :
                        accessory)].frames;
